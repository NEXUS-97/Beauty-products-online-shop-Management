...
--
-- Host: 127.0.0.1
-- Generation Time: May 08, 2022 at 03:00 PM
...
(1, 'Skin Care', ' Skin care is the range of practices that support skin integrity, enhance its appearance and relieve skin conditions. They can include nutrition, avoidance of excessive sun exposure and appropriate use of emollients.', 1, 0, '2022-02-17 11:27:11'),
(3, 'Body Care', ' Body care means how an individual performs applications of dressings and ointments or lotions to their body, trims their toe- nails, and applies lotion to their feet. Assistance with body care in- cludes general skin care and the application of over-the-counter oint- ments or lotions.', 1, 0, '2022-02-17 11:27:45'),
(4, 'Face Care', 'Think of your skin-care routine as consisting of three main steps: Cleansing &mdash; Washing your face. Toning &mdash; Balancing the skin. Moisturizing &mdash; Hydrating and softening the skin.', 1, 0, '2022-02-17 11:27:55'),
(5, 'Hair Care', 'Hair care is an overall term for hygiene and cosmetology involving the hair which grows from the human scalp, and to a lesser extent facial, pubic and other body hair. Hair care routines differ according to an individual&#039;s culture and the physical characteristics of one&#039;s hair.', 1, 0, '2022-02-17 11:28:38'),
(7, 'Eye Care', 'Eye makeup is a type of cosmetics which aims to make the eyes look noticeable and attractive. It is mostly used by females, and by stage performers of all types. Eye makeup is an important part of the fashion and cosmetic industries.', 1, 0, '2022-02-17 11:29:19'),
(8, 'Nail Care', 'Nail care, the maintenance of the fingernails and toenails, is important for health as well as cosmetic reasons. Good nail care can prevent fungus infections of the nail, painful ingrown fingernails and toenails, and infections of the skin in the hands and feet.', 1, 0, '2022-02-17 11:29:38'),
(9, 'Lip Care', ' A regular lip care routine can help keep your lips soft and smooth. Look for a lip balm with ingredients like shea butter or petrolatum. Apply anytime your lips feel dry. Exfoliate very dry lips once or twice per week, using sugar or salt mixed with nourishing oil, then follow up with a balm.', 1, 0, '2022-02-17 11:29:59');
...
(1, 'Super', 'Admin', 'admin', '0192023a7bbd73250516f069df18b500', 'uploads/avatars/1.png?v=1645064505', NULL, 1, '2021-01-20 14:02:37', '2022-05-08 18:11:58');
