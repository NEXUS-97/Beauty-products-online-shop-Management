        ...
        <div id="printable">
            <div class="row row-cols-2 justify-content-center align-items-center" id="print_header" style="display:none">
                ...
                <div class="col-7">
                    ...
                    <h3 class="text-center m-0"><b>Inventory Report</b></h3>
        ...
        <div class="container-fluid">
            <table class="table table-hover table-striped" id="list">
                ...
                <tbody>
                    ...
                    $i = 1;
                    $gtotal = 0;
                        $qry = $conn->query("SELECT * FROM `inventory` where date(date_created) between '{$date_start}' and '{$date_end}' order by unix_timestamp(date_created) desc ");
                    ...
                    ?>
                        <tr>
                            ...
                            <td ><?php echo $row['variant'] ?></p></td>
                            <td ><?php echo $row['quantity'] ?></p></td>
...
<script>
    $(function(){
        ...
        $('#filter-form').submit(function(e){
            e.preventDefault()
            location.href = "./?page=inventoryreport&date_start="+$('[name="date_start"]').val()+"&date_end="+$('[name="date_end"]').val()
        })
