...
<div class="card card-primary card-outline">
    <div class="card-header">
        <h5 class="card-title">Brand Report</h5>
    </div>
    <div class="card-body">
        <form id="filter-form">
        ...
        <div id="printable">
            <div class="row row-cols-2 justify-content-center align-items-center" id="print_header" style="display:none">
                ...
                <div class="col-7">
                    ...
                    <h3 class="text-center m-0"><b>Brand Report</b></h3>
        ...
        <div class="container-fluid">
            <table class="table table-hover table-striped" id="list">
                ...
                <tbody>
                    ...
                    $i = 1;
                    $gtotal = 0;
                        $qry = $conn->query("SELECT * FROM `brands` where date(date_created) between '{$date_start}' and '{$date_end}' order by unix_timestamp(date_created) desc ");
...
<script>
    $(function(){
        ...
        $('#filter-form').submit(function(e){
            e.preventDefault()
            location.href = "./?page=BrandRep&date_start="+$('[name="date_start"]').val()+"&date_end="+$('[name="date_end"]').val()
        })
