...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-pink elevation-4 sidebar-no-expand">
        <!-- Brand Logo -->
        <a href="<?php echo base_url ?>admin" class="brand-link bg-gradient-indigo text-sm">
              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=inventoryreport" class="nav-link nav-inventoryreport">
                        <i class="nav-icon fas fa-file"></i>
                        <p>
                          Inventory Report
                        </p>
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=OrderRep" class="nav-link nav-OrderRep">
                        <i class="nav-icon fas fa-file"></i>
                        <p>
                          Order Report
                        </p>
                     ...
                     <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=BrandRep" class="nav-link nav-BrandRep">
                        <i class="nav-icon fas fa-file"></i>
                        <p>
                          Brand Report
                        </p>
