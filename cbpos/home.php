...
<section class="py-0">
    <div class="container"><br>
           <div class="carousel-inner">
                      <img src="uploads/banner/102614.png"  alt="Italian Trulli">
            </div>
    <div class="row">
        <div class="col-lg-2 px-1 border-right text-sm position-sticky " style="margin-top:50px;" >
            <h4><b>Brands</b></h4>
            <ul class="list-group">
                <a href="" class="list-group-item list-group-item-action" style="background-color: #ff33cc;">
                ...
                ?>
                <li class="list-group-item list-group-item-action" style="background-color:#ff33cc;">
                    <div class="icheck-primary d-inline">
